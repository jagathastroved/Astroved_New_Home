...
const NAV_LINKS = [
  { label: 'Special Events', id: 'special-events', icon: Sparkles, color: 'text-purple-600 dark:text-purple-400', borderColor: 'border-purple-400/40', bgIcon: 'bg-purple-400/5' },
...
const DESKTOP_NAV_LINK_STYLES = "relative px-1 lg:px-1.5 xl:px-2 py-1.5 text-midnight/80 dark:text-cream/90 hover:text-amber-600 dark:hover:text-amber-400 transition-colors font-sans uppercase tracking-[0.05em] xl:tracking-widest text-[8px] lg:text-[9px] xl:text-[10px] font-semibold group whitespace-nowrap";
...
/* Buttons */
const DESKTOP_KUNDALI_BTN = "hidden lg:block px-3 lg:px-4 xl:px-5 py-1.5 xl:py-2 rounded-full bg-gradient-to-r from-amber-400 to-amber-500 text-midnight text-[8px] lg:text-[9px] xl:text-[10px] font-sans tracking-widest uppercase font-bold hover:from-amber-500 hover:to-orange-500 transition-all shadow-lg shadow-amber-500/25 whitespace-nowrap text-center";
const DESKTOP_SIGNIN_BTN = "hidden lg:block px-3 lg:px-4 xl:px-5 py-1.5 xl:py-2 rounded-full border border-midnight/60 dark:border-cream/60 text-midnight dark:text-cream text-[8px] lg:text-[9px] xl:text-[10px] font-sans tracking-widest uppercase font-bold hover:bg-midnight/5 dark:hover:bg-cream/10 transition-all whitespace-nowrap";
...
export function Navbar() {
  ...
  return (
    <header className={HEADER_STYLES}>
      <div className="w-full max-w-full mx-auto flex items-center justify-between px-6 py-3">

        {/* --- Logo & Mobile Toggle --- */}
        <div className="flex-1 flex items-center gap-1.5 lg:gap-3 min-w-max">
        ...
        {/* --- Desktop Navigation --- */}
        <nav className="hidden lg:flex justify-center items-center gap-0.5 lg:gap-1.5 xl:gap-3 text-sm font-medium">
        ...
        <div className="flex-1 flex items-center justify-end gap-1.5 lg:gap-3 sm:gap-4">
